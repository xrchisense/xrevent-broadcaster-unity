...
const options = {
    ...
    useStunTurn: true,
    bosh: `https://meet.jit.si/http-bind?room=akjwhgekjagdjkhawgdkjawhdskawhdkjwahdjkhwad`,
...
function changeAudioInput(selected) {
    selectedAudioId = selected.value;
    console.log("SelectedAudio: ",selected.value);
}
...
function startLocalTracks() {
    JitsiMeetJS.createLocalTracks(deviceOptions)
        .then(onLocalTracks)
        .catch(error => {
            throw error;
        });
